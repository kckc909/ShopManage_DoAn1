...
namespace BUS
{
    public class BUS_Voucher
    {
        ...
        public void Them(tblVoucher vc) => dal.Add(vc);
        public void Sua(tblVoucher _old, tblVoucher _new) => dal.Update(_old, _new);
        public void Xoa(string MaV) => dal.Delete(DSVoucher().Find(x => x.MaV.Equals(MaV)));
        public List<tblVoucher> DSVoucher() => dal.GetAll();
        public List<tblVoucher> DSVoucher(string str) => dal.GetAll().Where(
